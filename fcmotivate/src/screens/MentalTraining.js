...
import motivate_me_banner from '../utils/img/training1.jpg';
import recover_me_banner from '../utils/img/training1.jpg';
    ...
    <View
      ...
      <View style={{paddingVertical: 20}}>
          ...
          <TouchableOpacity
            ...
            <ImageBackground
              ...
              <View style={styles.banner_content}>
                ...
                <View>
                  <Text style={styles.title}>Teamwork</Text>
                  <Text style={styles.description}>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  </Text>
                </View>
        ...
        <View style={styles.banner_container}>
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('MentalTraining', {
